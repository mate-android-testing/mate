...
public enum InputFieldType {
    ...
    TEXT_VARIATION_POSTAL_ADDRESS("^[a-zA-Z0-9-]+", InputType.TYPE_TEXT_VARIATION_POSTAL_ADDRESS | InputType.TYPE_CLASS_TEXT),
    ...
    NUMBER_FLAG_SIGNED("", InputType.TYPE_NUMBER_FLAG_SIGNED | InputType.TYPE_CLASS_NUMBER),
    CLASS_NUMBER("^[0-9]+", InputType.TYPE_NUMBER_FLAG_DECIMAL | InputType.TYPE_CLASS_NUMBER),
    NUMBER_FLAG_DECIMAL("", InputType.TYPE_NUMBER_FLAG_DECIMAL | InputType.TYPE_CLASS_NUMBER),
