 ...
 */
public final class QBEAbstractAction implements QMatrix.AbstractActions<QBEAction> {

    @Override
    public int getAbstractActionIndex(final QBEAction action) {
        switch (action.getUiAction().getActionType()) {
            case MENU:
                return 0;
            case BACK:
                return 1;
